...
class ArtistaStickyScaffoldBottomSheet extends StatefulWidget {
  /// Creates a `SearchingProviderBottomSheet`.
  const ArtistaStickyScaffoldBottomSheet({
    super.key,
  ...
  @override
  State<ArtistaStickyScaffoldBottomSheet> createState() =>
      _ArtistaStickyScaffoldBottomSheetState();
}

class _ArtistaStickyScaffoldBottomSheetState extends State<ArtistaStickyScaffoldBottomSheet> {
